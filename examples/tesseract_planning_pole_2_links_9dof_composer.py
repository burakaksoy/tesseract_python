...
wp2 = StateWaypoint(joint_names, np.array([goal_x, goal_y, goal_z, goal_yaw, goal_pitch, goal_roll, 0.0, 0.0, 0.0]))

# wp_i0 = StateWaypoint(joint_names, np.array([i0_x, i0_y, i0_z, i0_yaw, i0_pitch, i0_roll]))
# wp_i0 = StateWaypoint(joint_names, np.array([i0_x, i0_y, i0_z, i0_yaw, i0_pitch, i0_roll, 0.0, 0.0, 0.0]))
wp_i0 = StateWaypoint(joint_names, np.array([i0_x, i0_y, i0_z, i0_yaw, i0_pitch, i0_roll, -np.pi/3, 0.0, 0.0]))

# wp_i1 = StateWaypoint(joint_names, np.array([i1_x, i1_y, i1_z, i1_yaw, i1_pitch, i1_roll]))
wp_i1 = StateWaypoint(joint_names, np.array([i1_x, i1_y, i1_z, i1_yaw, i1_pitch, i1_roll, 0.0, 0.0, 0.0]))
# wp_i1 = StateWaypoint(joint_names, np.array([i1_x, i1_y, i1_z, i1_yaw, i1_pitch, i1_roll, -np.pi/3, 0.0, 0.0]))

# wp_i2 = StateWaypoint(joint_names, np.array([i2_x, i2_y, i2_z, i2_yaw, i2_pitch, i2_roll]))
# wp_i2 = StateWaypoint(joint_names, np.array([i2_x, i2_y, i2_z, i2_yaw, i2_pitch, i2_roll, 0.0, 0.0, 0.0]))
wp_i2 = StateWaypoint(joint_names, np.array([i2_x, i2_y, i2_z, i2_yaw, i2_pitch, i2_roll, -np.pi/3, 0.0, 0.0]))
